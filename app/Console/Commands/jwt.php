...
class jwt extends Command
{
    ...
    public function handle()
    {
        ...
        $payload = array('sub'=>'1234567890', 'user_name'=>'vblanco', 'user_id'=>NULL, 'admin'=>true, 'exp'=>(time() + 3600));
        ...
        $signature = hash_hmac('SHA512', "$headers_encoded.$payload_encoded", 'clave', true);
